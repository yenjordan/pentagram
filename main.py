...
def keep_warm():
    health_url = "https://yenjordan--sd-demo-model-health.modal.run"
    generate_url = "https://yenjordan--sd-demo-model-generate.modal.run"
    ...
    headers = {"X-API-Key": os.environ["CLIENT_TOKEN_1"]}
